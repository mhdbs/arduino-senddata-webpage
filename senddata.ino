...
SoftwareSerial comm(9,10); //setting Tx and Rx pins

String server="2"; //variable for sending data to webpage
...
String str1="<p>Internet of things</p>";   //String to display on webpage
...
void wifi_init() //send AT commands to module
{
      ...
      if(!No_IP)
      {
        ...
        establishConnection("AT+CWJAP=\"MHDBS\",\"bilal\"",7000);         //provide your WiFi username and password here
      }
      else
        {
        }
